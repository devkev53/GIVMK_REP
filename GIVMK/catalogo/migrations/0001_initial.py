    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('precio_consultora', models.DecimalField(decimal_places=2, max_digits=12, verbose_name='Precio Consultora')),
                ('precio_catalogo', models.DecimalField(decimal_places=2, max_digits=12, verbose_name='Precio Catalogo')),
